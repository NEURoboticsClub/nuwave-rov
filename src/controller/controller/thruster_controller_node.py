...
class ThrusterController(Node):
    def __init__(self):
        ...
        # === Parameters ===
        self.declare_parameter('joy_config', '/home/nuwave-rov/install/controller/share/controller/config/joystick_config.yaml')
        self.declare_parameter('thruster_config', '/home/nuwave-rov/install/controller/share/controller/config/thruster_config.yaml')
